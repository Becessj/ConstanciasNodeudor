...
const baseContribuyente="http://192.168.1.5:5000/api/contribuyentes";
>>>>>>> a7817d7ef71bcd920ffcede0532ff4ae27d02366
...
const imprimirVehicular = (persona,carpeta,nombrecompleto,predioU,obs,hasta,recibo,f_pago,obs_ub) => {
  ...
  doc.setFontSize(12);  
  //doc.internal.write(0, "Tw") // <- add this
  doc.text('Que, la administrada '+ nombrecompleto +', tiene registrado un vehiculo en la juridicción de la MUNICIPALIDAD DISTRITAL DE SANTIAGO '+
...
const imprimirLimpieza = (persona,carpeta,nombrecompleto,predioU,obs,hasta,recibo,f_pago) => {
  ...
  doc.text(30, 220,'DISTRITAL DE SANTIAGO con Carpeta N°'+carpeta+' por el código del predio '+predioU,{ align: "justify"})
  doc.text(30, 235,'ubicado en el distrito de SANTIAGO, Provincia y Departamento del Cusco, habiendo cancelado',{ align: "justify"})
